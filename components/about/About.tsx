  ...
  useGSAP(
    () => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        gsap.from(".about-photo", { opacity: 0, scale: 0.95, duration: 1, ease: "power3.out", scrollTrigger: { trigger: sectionRef.current, start: "top 75%" } });
        gsap.from(".about-line", { opacity: 0, y: 28, duration: 0.8, stagger: 0.1, ease: "power3.out", scrollTrigger: { trigger: sectionRef.current, start: "top 72%" } });
        gsap.from(".about-stat", { opacity: 0, y: 16, duration: 0.6, stagger: 0.08, ease: "power3.out", scrollTrigger: { trigger: ".about-stats", start: "top 82%" } });
      });
      return () => mm.revert();
    },
    { scope: sectionRef }
          ...
          <div className="about-grid">
            ...
            <div className="about-photo about-photo-col">
              <div style={{ position: "relative", width: "100%", aspectRatio: "3/4", borderRadius: "1.5rem", overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)" }}>
                <Image src="/foto.png" alt="Bryan España" fill style={{ objectFit: "cover", objectPosition: "center top" }} priority />
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <motion.a
                ...
                style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", width: "fit-content", fontSize: "0.8rem", fontWeight: 500, letterSpacing: "0.12em", color: "#8a8a8e", textTransform: "uppercase", textDecoration: "none", borderBottom: "1px solid #3a3a3c", paddingBottom: "0.25rem" }}
