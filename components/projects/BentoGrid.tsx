  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "1152px", margin: "0 auto", paddingLeft: "3rem", paddingRight: "3rem" }}>
        {/* Row 1: Astro State grande + BilletesGT */}
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
          <BentoCard project={PROJECTS[0]} minHeight="320px" />
          <BentoCard project={PROJECTS[1]} minHeight="320px" />
        </div>
        {/* Row 2: FilApp + Space Access + Filpro */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1.5fr", gap: "1rem" }}>
          <BentoCard project={PROJECTS[2]} minHeight="260px" />
          <BentoCard project={PROJECTS[3]} minHeight="260px" />
          <BentoCard project={PROJECTS[4]} minHeight="260px" />
        </div>
      </div>
    </section>
  );
