...
export default function Hero() {
  ...
  return (
    <>
      <section
        ref={containerRef}
        style={{ position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", minHeight: "100vh", paddingTop: "7rem", paddingBottom: "5rem" }}
      >
        ...
        <div className="hero-container" style={{ maxWidth: "1152px", margin: "0 auto", width: "100%", paddingLeft: "3rem", paddingRight: "3rem" }}>
          ...
          <h1 className="hero-title" style={{ margin: 0, marginBottom: "2rem", lineHeight: 1, letterSpacing: "-0.02em" }}>
            {[tr.hero.line1, tr.hero.line2].map((line, i) => (
        ...
        <div className="hero-scroll" style={{ position: "absolute", bottom: "2.5rem", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", opacity: 0.4 }}>
          <span style={{ fontSize: "0.6rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#8a8a8e" }}>{tr.hero.scroll}</span>
          <motion.div
      ...
      <style>{`
        ...
        @media (min-width: 640px) { .hero-container { padding-left: 2rem !important; padding-right: 2rem !important; } }
        @media (min-width: 1024px) { .hero-container { padding-left: 3rem !important; padding-right: 3rem !important; } }
      `}</style>
    </>
  );
}
...
function MagneticButton({ children, variant = "primary", className = "", href, target, rel }: MagneticButtonProps) {
  ...
  return (
    <motion.a
      ...
      style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", borderRadius: "999px", padding: "0.9rem 2rem", fontSize: "0.9rem", fontWeight: 500, letterSpacing: "0.03em", cursor: "pointer", userSelect: "none", textDecoration: "none", background: isPrimary ? "#fff" : "transparent", color: isPrimary ? "#000" : "#8a8a8e", border: isPrimary ? "none" : "1px solid #3a3a3c" }}
